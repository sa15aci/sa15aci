...
class ViewController: UIViewController, subViewDelegate {
    ...
    @IBOutlet weak var replayButton: UIImageView!
      ...
      override func viewDidLoad() {
        ...
        //make car part of collision behavior and draggable
  //      func carBoundaries() {
   //         collisionBehavior.removeAllBoundaries()
     //       collisionBehavior.addBoundary(withIdentifier: "barrier" as
   //             NSCopying, for: UIBezierPath(rect: mainCar.frame))
        ...
        var replayButtonView = UIImageView(image: UIImage(named: "replay.png"))
        
        
        //Make this image view fulfil the screen
        gameOverView.frame = UIScreen.main.bounds
        
        replayButtonView.frame = CGRect(x: 170, y: 500, width: 80, height: 80)
        
        //game timer: 18 seconds, now 10 seconds for testing
